...
namespace HoloToolkit.Examples.SharingWithUNET
{
    ...
    public class PlayerController : NetworkBehaviour, IInputClickHandler
    {
        ...
        /// NetworkManager.
        /// </summary>
        public GameObject sharingObject;
        ...
        void CmdFire()
        {
            ...
            GameObject objectToSpawn = (GameObject)Instantiate(sharingObject, sharedWorldAnchorTransform.InverseTransformPoint(bulletPos), Quaternion.Euler(bulletDir));
